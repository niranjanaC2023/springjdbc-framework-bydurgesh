 ...
 *
 */
public class SpringJdbcTemplateConfigUsingXMLfile 
{
    ...
    public static void main( String[] args )
    {
       ...
       ApplicationContext context = new ClassPathXmlApplicationContext("com/nt/niranjana/spring/jdbc/config/dataSourceConfig.xml");
       
       /*
       JdbcTemplate template = context.getBean("jdbcTemplate",JdbcTemplate.class);
       //insert query
       String insertQuery = "insert into student(id,city,name)values(?,?,?)";
       int totalRowInsert = template.update(insertQuery, 104,"Kolkata","raja");
       System.out.println("Total Row inserted: "+totalRowInsert);
        */
     ...
     //update into student table
       ...
       student2.setId(106);  //existing id
     ...
     //delete from student table
       int totalStudentDeleted =  daoImpl.delete(106);
