...
import com.nt.niranjana.spring.jdbc.config.JavaConfigWithComponentAndAutowire;
import com.nt.niranjana.spring.jdbc.dao.StudentDaoImplWithComponentAndAutowire;
 ...
 *
 */
public class SpringJdbcTemplateConfigUsingComponentAutowireJavaConfig 
{
    ...
    public static void main( String[] args )
    {
       ...
       ApplicationContext context = new AnnotationConfigApplicationContext(JavaConfigWithComponentAndAutowire.class);
       
       //IStudentDao dao = context.getBean("studentdaoimpl",IStudentDao.class);       //also work
       StudentDaoImplWithComponentAndAutowire daoImpl = context.getBean("studentdaoimpl",StudentDaoImplWithComponentAndAutowire.class);
     ...
     //delete from student table
       ...
       int totalStudentDeleted =  daoImpl.delete(102);
